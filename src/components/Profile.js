...
const Profile = () => {
  ...
  const handleClick = async (event) => {
    ...
    axios
      .post("https://630b3c26f280658a59d82ec1.mockapi.io/url", {
        url: urlToPosts,
      })
      .catch((error) => {
      ...
      <div className="card">
        ...
        <div className="card-home">
          <div className="card-header">
            ...
            ></div>
            <img className="card-avatar" src={user.picture} alt={user.name} />
          ...
          <div className="card-section">
            <div className="card-content">
              ...
              <div className="add-url">
                ...
                />
                <input onClick={handleClick} value="Add Url" type="submit" />
              </div>
              <UrlRequest />
            </div>
          </div>
